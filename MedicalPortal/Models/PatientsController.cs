...
namespace MedicalPortal.Models
{
    public class PatientsController : Controller
    {
        ...
        public PatientsController(MedicalPortalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,BirthDate,Gender,Diagnosis")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,BirthDate,Gender,Diagnosis")] Patient patient)
        {
            if (id != patient.Id)
            {
                return NotFound();
